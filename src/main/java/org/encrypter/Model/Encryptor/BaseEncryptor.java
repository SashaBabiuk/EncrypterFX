...
public class BaseEncryptor implements Encryptor {
    ...
    public void encode(File inputFile, int key) {
        File outputFile = new File("src/main/resources/" + getFileName(inputFile, ENCRYPTED, ".txt"));
    ...
    public void decode(File inputFile, int key) {
        File outputFile = new File("src/main/resources/" + getFileName(inputFile, DECRYPTED, ".txt"));
        this.outputFile = outputFile;
        try {
            String content = FileService.readFile(inputFile);
    ...
    String decodeContent(String content, int key) {
    ...
    String encodeContent(String content, int key) {
